...
import sk.ai.net.solutions.ka2a.models.Part
import sk.ai.net.solutions.ka2a.models.TextPart
import sk.ai.net.solutions.ka2a.models.StringOrInt
...
fun A2ARequest.toJsonRpcRequest(): JsonRpcRequest {
    return sk.ai.net.solutions.ka2a.models.SendTaskRequest(
        jsonrpc = "2.0",
        id = StringValue(this.id),
        params = sk.ai.net.solutions.ka2a.models.TaskSendParams(
            id = this.id,
            message = Message(
                role = "user",
...
fun JsonRpcResponse.toA2AResponse(requestId: String): A2AResponse {
    return when (this) {
        is sk.ai.net.solutions.ka2a.models.SendTaskResponse -> {
